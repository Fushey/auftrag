    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-gradient-to-b from-indigo-800 to-indigo-900 text-white">
            <div class="p-6">
                ...
                <nav>
                    <a href="https://auftrag.immoyes.com/index.php" class="sidebar-link flex items-center py-3 px-4 rounded-lg transition duration-200 hover:bg-white hover:bg-opacity-10 mb-2">
