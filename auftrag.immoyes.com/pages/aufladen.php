        ...
        <aside id="sidebar" class="sidebar w-64 bg-gradient-to-b from-indigo-800 to-indigo-900 text-white">
            <div class="p-6">
                ...
                <nav>
                    ...
                    <a href="https://auftrag.immoyes.com/index.php?page=aufladen" class="sidebar-link active flex items-center py-3 px-4 rounded-lg transition duration-200 hover:bg-white hover:bg-opacity-10 mb-2">
            ...
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div id="bank-transfer-screen" class="bg-white shadow-lg rounded-lg p-6 mb-8 hidden">
                    ...
                    <div id="bank-transfer-info" class="mt-8 p-4 bg-gray-100 rounded-lg">
                        ...
                        <p class="mb-2"><strong>Empfänger:</strong> Tobias Jansen ImmoYes</p>
                        <p class="mb-2"><strong>IBAN:</strong>DE18370694127800816038</p>
                        <p class="mb-2"><strong>BIC:</strong> GENODED1HRB</p>
                        <p class="mb-2"><strong>Bank:</strong> Volksbank Heinsberg</p>
