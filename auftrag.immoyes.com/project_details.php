 ...
 <!-- Sidebar -->
        <aside class="w-64 bg-gradient-to-b from-indigo-800 to-indigo-900 text-white">
            <div class="p-6">
                ...
                <a href="http://auftrag.immoyes.com/admin.php" class="sidebar-link active flex items-center py-3 px-4 rounded-lg transition duration-200 hover:bg-white hover:bg>
                        <i class="fas fa-project-diagram sidebar-icon mr-3 text-lg"></i>
                        <span class="font-medium">Auftraege</span>
                    </a>
                    <a href="http://auftrag.immoyes.com/pages/operatorchat.php" class="sidebar-link flex items-center py-3 px-4 rounded-lg transition duration-200 hover:bg-whit>
                        <i class="fas fa-project-diagram sidebar-icon mr-3 text-lg"></i>
                        <span class="font-medium">Chat</span>
                    </a>

                    <a href="http://auftrag.immoyes.com/pages/analytics.php" class="sidebar-link flex items-center py-3 px-4 rounded-lg transition duration-200 hover:bg-white h>
            ...
            if (!project.images || project.images.length === 0) {
                ...
                project.images.forEach((image, index) => {
                    ...
                    if (project.final_images && project.final_images[index]) {
                        finalImageHtml = `
                            <img src="http://auftrag.immoyes.com/finalized_uploads/${project.final_images[index]}" alt="Finales Projektbild" class="w-full h-48 object-cover mb-2">
